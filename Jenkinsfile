    ...
    stages {
        ...
        stage('Owasp zap') {
            ...
            container('zap') {
                ...
                sh """
                    zap-baseline.py -t $TARGET_URL -x $ZAP_REPORT -l WARN -I
                    mv /zap/wrk/${ZAP_REPORT} .
                """
                publishReport name: "ZAP Report", displayType: "DAST", provider: xml(pattern: "zap-out.xml")
